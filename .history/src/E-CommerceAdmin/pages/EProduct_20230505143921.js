    ...
    return (
      ...
      >
        ...
        <Modal.Body>
          <p className="View">
            {" "}
            <strong>Name : </strong> {singleProduct?.product_name}{" "}
          </p>
          <p className="View">
            {" "}
            <strong>asin : </strong> {singleProduct?.product_name}
          </p>

          <p className="View">
            {" "}
            <strong>Description : </strong>  {singleProduct?.product_name}{" "}
          </p>

          <p className="View">
            {" "}
            <strong>Discount : </strong>  {singleProduct?.product_name}{" "}
          </p>
          <p className="View">
            {" "}
            <strong>Price : </strong>  {singleProduct?.product_name}{" "}
          </p>

          <p className="View">
            {" "}
            <strong>Stock : </strong>  {singleProduct?.product_name}{" "}
          </p>
          <p className="View">
            {" "}
            <strong>Features : </strong>  {singleProduct?.product_name}{" "}
          </p>
          ...
          <p className="View">
            {" "}
            <strong>Added By : </strong>  {singleProduct?.product_name}{" "}
          </p>
        </Modal.Body>
      </Modal>
    );
