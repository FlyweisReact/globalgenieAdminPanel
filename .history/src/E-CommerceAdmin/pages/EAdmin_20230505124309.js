...
const EAdmin = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const postHandler = async (e) => {
      e.preventDefault()
      try{ 
        const { data} = await axios.post("http://ec2-65-1-248-95.ap-south-1.compute.amazonaws.com:8886/api/auth/register" , {
          name , email , password , passwordConfirmation , phone , role : "admin"
        })
      }catch(e)  {
         console.log(e)
      }
