    ...
    return (
      ...
      >
        ...
        <Modal.Body>
          ...
          <p className="View">
            {" "}
            <strong>Description : </strong>  {singleProduct?.id}{" "}
          </p>

          <p className="View">
            {" "}
            <strong>Discount : </strong>  {singleProduct?.description}{" "}
          </p>
          <p className="View">
            {" "}
            <strong>Price : </strong>  {singleProduct?.brand}{" "}
          </p>

          <p className="View">
            {" "}
            <strong>Stock : </strong>  {singleProduct?.color}{" "}
          </p>
          <p className="View">
            {" "}
            <strong>Features : </strong>  {singleProduct?.image_url?.map((i , index) => (
              <p key={index}> {i} </p>
            ))}{" "}
          </p>
          ...
          <p className="View">
            {" "}
            <strong>stock : </strong>  {singleProduct?.bullet_text?.map((i , index) => (
              <p> {i} </p>
            ))}{" "}
          </p>
          <p className="View">
