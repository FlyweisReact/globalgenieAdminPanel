...
const Coupon = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const postHandler = async () => {
      try {
        const { data } = await axios.post("http://ec2-65-1-248-95.ap-south-1.compute.amazonaws.com:8886/api/discount/generate" , {
          codeLength , 
          discountStart , 
          discountEnd , 
          availableStart , 
        ...
        <Modal.Body>
          <Form onSubmit={postHandler}>
            <Form.Group className="mb-3" >
              ...
              <Form.Control type="number" min={0} required onChange={(e) => setCodeLength(e.target.value)} />
            </Form.Group>
