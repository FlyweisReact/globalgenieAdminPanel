...
const EProduct = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const postHandler = async (e) => {
      ...
      fd.append("image_url" , imageArray)
      fd.append("bullet_text" , bullet_text)
      ...
      try {
        const { data } = await axios.post(
          "http://ec2-65-1-248-95.ap-south-1.compute.amazonaws.com:8886/api/product/" , fd
        );
      } catch (e) {
        console.log(e);
      }
    ...
    return (
      ...
      >
        ...
        <Modal.Body>
          <Form>
          {
            loadingMessage ? <Spinner animation="border" role="status">
      <span className="visually-hidden">Loading...</span>
          ...
          <Form.Group className="mb-3">
            ...
            <Button style={{height : '40px' , marginTop : '15px'}} onClick={() => uploadImages() } >Upload</Button>
          </div>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Select aria-label="Default select example" required    onChange={(e) =>setProductName(e.target.value)}>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" required placeholder=""     onChange={(e) =>setProductName(e.target.value)}/>
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label>Price</Form.Label>
              <Form.Control type="text" required placeholder=""    onChange={(e) =>setProductName(e.target.value)} />
