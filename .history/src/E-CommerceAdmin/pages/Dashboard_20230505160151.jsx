...
const Dashboard = () => {
  ...
  const fetchAdmin  = async () => {
    try { 
      ...
      setAdminCount(data.users.filter((i) => i.role.includes('role')))
   console.log(data.users?.filter((i) => i?.role.includes("admin")))
    }catch(e) { 
      console.log(e)
    }
  }
  ...
  const card = [
    ...
    },
    {
      ...
      title: "Total Users",
      number: "10",
      icon:<i className="fa-solid fa-user text-2xl" style={{color : '#4099ff'}} ></i>,
      bg: "#4099ff",
      link : '/Customer'
    },
    {
    ...
    },
    {
      ...
      title: "All orders",
      number: "100",
      icon: <i className=" fa-solid fa-bag-shopping text-2xl text-[#1b6975]" ></i>,
      bg: "#1b6975",
      link : '/Orders'
    },
    {
