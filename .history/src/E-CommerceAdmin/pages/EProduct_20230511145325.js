...
const EProduct = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const newArray = Array.from({ length: imageArray.length }, () => "");
const imageUrlArray = newArray.map((_, index) =>
  imageArray[index] ? imageArray[index] : ""
);
    ...
    const postHandler = async (e) => {
      ...
      try {
        const { data } = await axios.post(
          "http://ec2-65-1-248-95.ap-south-1.compute.amazonaws.com:8886/api/product/",
         {
          product_name , description , category , price , priceDiscount , 
          id , asin , images : [imageUrlArray]  , bullet_text ,quantity
         } 
          ...
          <Form onSubmit={postHandler}>
          {
            ...
            <Form.Group className="mb-3">
              ...
              >
                ...
                <option value='6454b30d80c98d7b3d803d1c' >First Category</option>
