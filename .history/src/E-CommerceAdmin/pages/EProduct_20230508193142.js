...
const EProduct = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const postHandler = async (e) => {
      ...
      try { 
        const { data } = await axios.post("http://ec2-65-1-248-95.ap-south-1.compute.amazonaws.com:8886/api/product/" , )
      }catch(e) { 
        console.log(e)
      }
    }
    ...
    const ImageUploader = async (e) => {
      ...
      fd.append("cloud_name", "dbcnha741");   fd.append("upload_preset" )
      try { 
        const { data } = await axios.post("https://api.cloudinary.com/v1_1/dbcnha741/image/upload" , fd )
        console.log(data)
      } catch(e) { 
        console.log(e)
      } 
        ...
        <Modal.Body>
          <Form>
            <Form.Group className="mb-3">
              ...
              <Form.Control type="file" required multipl
              
              e onChange={(e) => setManyImages(e.target.files)} />
            </Form.Group>

            <Form.Group className="mb-3">
              <Form.Label> Product Name</Form.Label>
              <Form.Control type="text" required placeholder="Product Name" onClick={() => postthumbImage()} />
            </Form.Group>
